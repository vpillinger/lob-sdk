 ...
 */
type OnBotPlayScriptSync = (game: IServerGame, playerNumber: number) => TurnSubmission;
/**
 * An asynchronous bot play script function.
 */
type OnBotPlayScriptAsync = (game: IServerGame, playerNumber: number) => Promise<TurnSubmission>;
/**
