 ...
 */
export type OrderPathPoint = [number, number];
/**
 * Order to walk along a specified path.
 */
export interface WalkOrder extends BaseOrder, Omit<ExclusiveOrderProps, "path"> {
    /** Order type is Walk. */
    type: OrderType.Walk;
 ...
 */
export interface WalkFollowOrder extends BaseOrder, Omit<ExclusiveOrderProps, "targetId"> {
    /** Order type is Walk. */
    type: OrderType.Walk;
 ...
 */
export interface FallbackOrder extends BaseOrder, Omit<ExclusiveOrderProps, "path"> {
 ...
 */
export interface FallbackFollowOrder extends BaseOrder, Omit<ExclusiveOrderProps, "targetId"> {
    /** Order type is Fallback. */
    type: OrderType.Fallback;
 ...
 */
export interface RunFollowOrder extends BaseOrder, Omit<ExclusiveOrderProps, "targetId"> {
    /** Order type is Run. */
    type: OrderType.Run;
    /** Entity ID of the target unit to follow. */
    targetId: EntityId;
 ...
 */
export interface ShootTargetOrder extends BaseOrder, Omit<ExclusiveOrderProps, "targetId"> {
    /** Order type is Shoot. */
 ...
 */
export interface ShootLocationOrder extends BaseOrder, Omit<ExclusiveOrderProps, "pos"> {
    /** Order type is Shoot. */
    type: OrderType.Shoot;
 ...
 */
export interface RotateTargetOrder extends BaseOrder, Omit<ExclusiveOrderProps, "targetId"> {
 ...
 */
export interface RotateLocationOrder extends BaseOrder, Omit<ExclusiveOrderProps, "pos"> {
    /** Order type is Rotate. */
    type: OrderType.Rotate;
    /** Target position as [x, y] coordinates. */
    pos: [number, number];
 ...
 */
export interface FireAndAdvanceToTargetOrder extends BaseOrder, Omit<ExclusiveOrderProps, "targetId"> {
 ...
 */
export interface FireAndAdvanceOnPathOrder extends BaseOrder, Omit<ExclusiveOrderProps, "path"> {
    /** Order type is FireAndAdvance. */
    type: OrderType.FireAndAdvance;
 ...
 */
export interface PlaceEntityOrder extends BaseOrder, Omit<ExclusiveOrderProps, "pos"> {
 ...
 */
export type AnyOrder = WalkOrder | WalkFollowOrder | RunOrder | RunFollowOrder | ShootTargetOrder | ShootLocationOrder | RotateTargetOrder | RotateLocationOrder | FireAndAdvanceToTargetOrder | FireAndAdvanceOnPathOrder | PlaceEntityOrder | FallbackOrder | FallbackFollowOrder;
/**
 * Order types that use paths for movement.
 */
export type PathOrderType = OrderType.Walk | OrderType.FireAndAdvance | OrderType.Fallback;
/**
 * Union type representing orders that use paths.
 */
export type PathOrder = WalkOrder | RunOrder | FallbackOrder | FireAndAdvanceOnPathOrder;
/**
