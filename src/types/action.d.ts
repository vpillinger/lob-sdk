 ...
 */
export type AnyAction = MoveAction | RotateAction | AttackAction | RangedAttackAction | UnitDestroyedAction | UpdateUnitStateAction | TickAction | PlaceEntityAction | UpdateObjectiveStateAction | AddUnitsAction | AddObjectivesAction | FormationChangeAction | TurnAction;
