...
import { TerrainType, GameMap, ProceduralScenario, DynamicBattleType, ObjectiveDto, ObjectiveType } from "@lob-sdk/types";
 ...
 */
export type AnyInstruction = InstructionTerrainNoise | InstructionHeightNoise | InstructionTerrainCircle | InstructionTerrainRectangle | InstructionNaturalPath | InstructionConnectClusters | InstructionObjective | InstructionLake | InstructionObjectiveLayer;
export {};
