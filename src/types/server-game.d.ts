import { AnyAction, RangedAttackAction, TurnSubmission, PlayerInfo, UserTier, GameScenarioType, GameLocales, GameClientEventDto, GameTrigger, ITriggerSystem, UnitDtoPartialId, UnitType, UnitCounts, ObjectiveDto, GameMap, TerrainType, FogOfWarResult, IServerFogOfWarService, IOrderManager, IOrganizationSystem, IAttackSystem, IMovementSystem, Player, UnitDto } from "@lob-sdk/types";
...
export interface IServerGame {
     ...
     */
    createPlayer(userId: number, username: string, elo: number, userTier: UserTier, playerNumber?: number): Player;
    /**
     ...
     */
    handleTurnStatus(turnStatus: TurnStatus, options?: Partial<HandleTurnStatusOptions>): Promise<void>;
    /**
     ...
     */
    getShotTrajectory(unit: BaseUnit, targetPosition: Vector2, ignoreEffects?: boolean, forAutofire?: boolean): any;
    /**
     ...
     */
    shoot(gameDataManager: GameDataManager, unit: BaseUnit, targetPosition: Vector2): ShootResult | null;
    /**
     ...
     */
    calculateRangedDamage(shooter: BaseUnit, target: BaseUnit, damageType: string, stepStrength: number): DamageHit;
    /**
     ...
     */
    calculateMeleeDamage(attacker: BaseUnit, defender: BaseUnit, side: Direction, isCharging: boolean): DamageHit | null;
    /**
     ...
     */
    getClosestObjective(position: Vector2, condition: (objective: BaseObjective) => boolean): BaseObjective | null;
    /**
     ...
     */
    getClosestEnemyObjective(position: Vector2, team: number): BaseObjective | null;
    /**
     ...
     */
    getClosestAllyObjective(position: Vector2, team: number): BaseObjective | null;
    /**
     ...
     */
    getVisibleNearbyUnits(playerNumber: number, position: Vector2, range: number): BaseUnit[];
    /**
     ...
     */
    getVisibleClosestUnitOf(playerNumber: number, position: Vector2, units: BaseUnit[]): BaseUnit | null;
    /**
     ...
     */
    getNearbyUnits<T extends BaseUnit = BaseUnit>(position: Point2, height: number): T[];
}
/**
