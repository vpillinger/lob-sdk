...
class Circle {
    shapeType = types_1.ShapeType.Circle;
    position;
    radius;
    constructor(centerX, centerY, radius) {
        ...
        this.position = new vector_1.Vector2(centerX, centerY);
        this.radius = radius;
    }
    _boundingBox = null;
    get boundingBox() {
     ...
     */
    getCollisionSquaredDistance(other) {
    ...
    intersectsWithPolygon(polygon) {
        ...
        if (this.boundingBox.minX > polyBox.maxX ||
     ...
     */
    intersectsWithLine(lineStart, lineEnd, lineWidth = 0) {
        ...
        if (this.boundingBox.minX > lineBoxMaxX ||
        ...
        const t = Math.max(0, Math.min(1, ((this.position.x - lineStart.x) * dx +
        ...
        const distanceSquared = dxToClosest * dxToClosest + dyToClosest * dyToClosest;
